      ...
      <div className="container">
        ...
        {activeTab === 'craft' && (
          <div className="crafting-section">
            <div className="crafting-info-banner">
              <h3>💡 Зачем нужен крафт?</h3>
              <p>Крафт позволяет создавать более ценные материалы, которые можно продать за большое количество эссенции или использовать для создания легендарных предметов!</p>
              <ul>
                <li>🔨 <strong>Базовые рецепты</strong> - компактное хранение ресурсов</li>
                <li>⚡ <strong>Продвинутые рецепты</strong> - создание магических предметов</li>
                <li>🌟 <strong>Легендарные рецепты</strong> - мощные артефакты с огромными бонусами</li>
              </ul>
            </div>
